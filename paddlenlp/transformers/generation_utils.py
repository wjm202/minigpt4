...
class GenerationMixin(object):
    ...
    def get_stopping_criteria(max_length: Optional[int], stopping_criteria: Optional[StoppingCriteriaList]):
        ...
        if len(stopping_criteria) == 0:
            return criteria
        for default in criteria:
            for custom in stopping_criteria:
    ...
    def generate(
        ...
        **model_kwargs
        ...
        if model_kwargs.get("attention_mask", None) is None:
            ...
            model_kwargs["attention_mask"] = self.prepare_attention_mask_for_generation( model_kwargs["inputs_embeds"], pad_token_id, eos_token_id)
        ...
        max_length= model_kwargs["max_new_tokens"]+input_ids.shape[-1]
