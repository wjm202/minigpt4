...
class Registry:
    mapping = {'builder_name_mapping': {}, 'task_name_mapping': {},
        ...
        'lr_scheduler_name_mapping': {}, 'runner_name_mapping': {}, 'state':
        {}, 'paths': {}}
    ...
    def register_builder(cls, name):
        ...
        def wrap(builder_cls):
            ...
            if name in cls.mapping['builder_name_mapping']:
                raise KeyError("Name '{}' already registered for {}.".
                    format(name, cls.mapping['builder_name_mapping'][name]))
    ...
    def register_task(cls, name):
        ...
        def wrap(task_cls):
            ...
            if name in cls.mapping['task_name_mapping']:
                raise KeyError("Name '{}' already registered for {}.".
                    format(name, cls.mapping['task_name_mapping'][name]))
    ...
    def register_model(cls, name):
        ...
        def wrap(model_cls):
            ...
            if name in cls.mapping['model_name_mapping']:
                raise KeyError("Name '{}' already registered for {}.".
                    format(name, cls.mapping['model_name_mapping'][name]))
    ...
    def register_processor(cls, name):
        ...
        def wrap(processor_cls):
            ...
            if name in cls.mapping['processor_name_mapping']:
                raise KeyError("Name '{}' already registered for {}.".
                    format(name, cls.mapping['processor_name_mapping'][name]))
    ...
    def register_lr_scheduler(cls, name):
        ...
        def wrap(lr_sched_cls):
            if name in cls.mapping['lr_scheduler_name_mapping']:
                raise KeyError("Name '{}' already registered for {}.".
                    format(name, cls.mapping['lr_scheduler_name_mapping'][
                    name]))
    ...
    def register_runner(cls, name):
        ...
        def wrap(runner_cls):
            if name in cls.mapping['runner_name_mapping']:
                raise KeyError("Name '{}' already registered for {}.".
                    format(name, cls.mapping['runner_name_mapping'][name]))
